...
export function Card({ cardId }: CardProps): ReactNode {
  ...
  return (
    <>
      ...
      >
        {/* Drag handle — always visible on mobile, hover-visible on desktop */}
        <div
          {...attributes}
          {...listeners}
          className={
            'absolute left-0.5 top-1/2 -translate-y-1/2 cursor-grab rounded p-0.5 text-[var(--color-text-muted)] hover:bg-[var(--color-bg-hover)]' +
        ...
        <div className={isMobile ? 'ml-5' : 'group-hover:ml-5'}>
